...
- `README.md`
- `00-前言与阅读说明.md`
- `01-OpenClaw-总览与学习路线.md`
- `02-OpenClaw-安装部署与首次跑通.md`
- `03-OpenClaw-配置命令与日常维护.md`
- `04-OpenClaw-架构原理与源码导读.md`
...
- `openclaw_comprehensive_guide.md.resolved`
...
- `skill-length-complexity-explained.zh-CN.md`
- `skills-cross-agent-compat-install-beginner.zh-CN.md`

### 单个 Skill 翻译

- `coding-agent.zh-CN.md`
- `gemini.zh-CN.md`
- `healthcheck.zh-CN.md`
- `skill-creator.zh-CN.md`
- `weather.zh-CN.md`
